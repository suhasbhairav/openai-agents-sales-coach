...
| This Template Page | [https://suhasbhairav.com/ai-templates/openai-agents-sales-coach](https://suhasbhairav.com/ai-templates/openai-agents-sales-coach) |
| Creator | [https://suhasbhairav.com](https://suhasbhairav.com) |

## One-Click Deploy

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fsuhasbhairav%2Fopenai-agents-sales-coach&env=OPENAI_API_KEY%2COPENAI_AGENT_MODEL&envDescription=Add+the+server-side+API+keys+required+by+this+template.+These+values+are+stored+as+deployment+environment+variables+and+are+not+committed+to+the+repository.&envLink=https%3A%2F%2Fgithub.com%2Fsuhasbhairav%2Fopenai-agents-sales-coach%23environment-variables)
...
`OpenAI Agents SDK template` · `openai agents sdk nextjs starter` · `AI agents starter` · `agentic AI template` · `AI templates` · `AI starter template` · `Next.js AI templates` · `nextjs ai templates` · `OpenAI templates` · `open ai templates` · `OpenAI Agents Sales Coach` · `Next.js AI template`
